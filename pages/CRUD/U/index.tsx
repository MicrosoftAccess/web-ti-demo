                ...
                <div className='h-full w-10/12 justify-center items-center bg-white flex-row rounded-xl flex'>
                    <div className='flex flex-col w-3/5 gap-3 justify-center items-center'>
                        ...
                        <div className='w-full flex flex-row justify-between'>
                            ...
                            <input className='w-5/12 h-10 rounded' placeholder='Juego 1' type="text" />
                            <input className='w-5/12 h-10 rounded' placeholder='$12.50' type="text" />
                        </div>

                        <input className='w-full h-24 rounded' placeholder='Juego multijugador de accion ...' type="text" />
                        <input className='w-full h-10 rounded' placeholder='accion,multijugador' type="text" />
                        <button className='w-full text-white h-10 bg-green-400 rounded border-none'>Actualizar</button>
